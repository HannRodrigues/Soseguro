  ...
  const handleEnviarLocalização = async () => {
    ...
    Geolocation.getCurrentPosition(
      (position) => {
        ...
        const mensagem = `Olá, aconteceu um acidente nesse endereço, envie uma viatura. Minha localização é: https://www.google.com/maps/search/?api=1&query=${latitude},${longitude}`;
  ...
  return (
    <View style={styles.container}>
      <View style={styles.section}>
        <Text style={styles.promptText}>Solicitar Viatura</Text>
